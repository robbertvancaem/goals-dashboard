...
/**
 * The total amount of new potential needed is calculated as follows:
 * The historical conversion from the Asana Sales Pipeline is 53%. In order to
 * realise the goal of 150k in revenue, a potential revenue of 283k is needed. At
 * the time of writing this, the standing amount of value is 91k. As  a result,
 * in the coming weeks we need new potential revenue of 192k.
 */
export const POTENTIAL_TARGET = 192000;
