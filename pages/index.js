...
export default function Home({
  ...
  return (
    <div className="w-full p-16 text-white bg-black min-h-screen leading-6">
      <Head>
        <title>OOGT - Reports</title>
      </Head>
      <h1 className="text-4xl text-center mb-8 font-bold">OOGT Reports</h1>
      <div className="text-center mb-16 text-gray-500">
        <i>Last update: </i>
        {lastUpdate}
      </div>
      <h2 className="text-xl mb-8 font-bold">Goal #1: Revenue 2021</h2>
      <p className="text-sm">
        Main target is to have <strong>&euro;150.000</strong> in{" "}
        <strong>new</strong> revenue by the end of 2021. The way this is
      ...
      <p className="text-sm">
        For every staff member that is billable (being Hulsman, Michiel, Brent,
        Stoop (half of his time) and Robbert), we agreed on the ambition of
